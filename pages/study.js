                    ...
                    <div className='md:px-16 px-6 w-auto h-screen' style={{ backgroundImage: `url(./images/bg.png)` }}>
                        ...
                        <div className='flex flex-col space-y-3 items-center'>
                            ...
                            <div className='pt-3 sm:w-96 w-full'>
                                <button className='rounded-md uppercase bg-secondary text-white sm:w-96 w-full py-2 font-semibold'>Submit</button>
                            </div>
                        </div> */}
                        <h1 className='font-Jost text-center font-bold md:text-5xl text-4xl text-black py-16'>Coming Soon...</h1>
                    </div>
                </Layout>
            </div>
        </div>
